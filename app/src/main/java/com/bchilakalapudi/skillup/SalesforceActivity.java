...
public class SalesforceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* refresh = findViewById(R.id.btn_refresh);
        ...
        Button btn_sfdc_pd1 = findViewById(R.id.btn_sfdc_pd1);
        btn_sfdc_pd1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View unusedView) {
                Intent in=new Intent(SalesforceActivity.this,StudyActivity.class);
                in.putExtra("exam","Certified Salesforce Platform Developer 1");
                startActivity(in);            }
        });
    }
    /**

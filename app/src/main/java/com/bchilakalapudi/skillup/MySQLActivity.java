...
public class MySQLActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* refresh = findViewById(R.id.btn_refresh);
        ...
        Button js_start_btn = findViewById(R.id.js_start_btn);
        js_start_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View unusedView) {
                Intent in=new Intent(MySQLActivity.this,StudyActivity.class);
                in.putExtra("exam",Keys.KEY_MYSQL);
                startActivity(in);
            }
        });
    }
...
//        refresh.setEnabled(false);
        ...
        builder.forUnifiedNativeAd(new UnifiedNativeAd.OnUnifiedNativeAdLoadedListener() {
            ...
            public void onUnifiedNativeAdLoaded(UnifiedNativeAd unifiedNativeAd) {
                ...
                FrameLayout frameLayout =
                        findViewById(R.id.mysql_fl_adplaceholder);
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener() {
            ...
            public void onAdFailedToLoad(int errorCode) {
                //  refresh.setEnabled(true);
                Toast.makeText(MySQLActivity.this, "Failed to load native ad: "

...
public class CSSActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* refresh = findViewById(R.id.btn_refresh);
        ...
        Button css_start_btn = findViewById(R.id.css_start_btn);
        css_start_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View unusedView) {
                Intent in=new Intent(CSSActivity.this,StudyActivity.class);
                in.putExtra("exam",Keys.KEY_CSS);
                startActivity(in);
            }
        });
    }
        ...
        builder.forUnifiedNativeAd(new UnifiedNativeAd.OnUnifiedNativeAdLoadedListener() {
            ...
            public void onUnifiedNativeAdLoaded(UnifiedNativeAd unifiedNativeAd) {
                ...
                FrameLayout frameLayout =
                        findViewById(R.id.css_fl_adplaceholder);

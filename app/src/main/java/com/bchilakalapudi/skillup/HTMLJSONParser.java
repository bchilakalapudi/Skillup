...
public class HTMLJSONParser {
    ...
    private static final String MAIN_URL = "https://script.google.com/macros/s/AKfycbxOLElujQcy1-ZUer1KgEvK16gkTLUqYftApjNCM_IRTL3HSuDk/exec?id=1pyFDH3-VSrtsmFyKrw8yN-fXmmWXsxMP2_pWIpzsAWg&sheet=HTML";
    ...
    public static final String TAG = "SalesforceJSONParser TAG";
